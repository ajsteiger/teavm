...
otv_StepRecorder_captureRef = ($name, $value) => {
    ...
    if (otv_StepRecorder_truncated)
        return;
    if ($value === null) {
        otv_StepRecorder_jsCaptureVar($name, $rt_s(3));
        return;
    }
    if (!($value instanceof jl_String) && !($value instanceof jl_Number) && !($value instanceof jl_Boolean) && !($value instanceof jl_Character)) {
        ...
        var$5 = (jl_StringBuilder__init_0($rt_s(4))).$append2(jl_Integer_toUnsignedString($id));
        $sb = ((var$5.$append2($rt_s(5))).$append2(jl_Class_getSimpleName($cls))).$append2($rt_s(6));
        $first = 1;
            ...
            a: {
                ...
                if (!jlr_Modifier_isStatic($f.$getModifiers())) {
                    ...
                    if (!$first)
                        $sb.$append2($rt_s(7));
                    $first = 0;
                    ($sb.$append2($f.$getName())).$append2($rt_s(8));
                    if ($fval === null)
                        $sb.$append2($rt_s(3));
                    else if (!($fval instanceof jl_String) && !($fval instanceof jl_Number) && !($fval instanceof jl_Boolean) && !($fval instanceof jl_Character))
                        ($sb.$append2($rt_s(4))).$append2(jl_Integer_toUnsignedString(jl_System_identityHashCode($fval)));
                    else
                        $sb.$append($fval);
                }
            }
...
otv_StepRecorder_jsStep = ($className, $methodName, $line) => {
    let $sb, $i, var$6;
    otv_StepRecorder_$callClinit();
    $sb = jl_StringBuilder__init_0($rt_s(10));
    $i = 0;
    ...
    (jl_System_err()).$println($sb.$toString());
},
otv_StepRecorder_jsEnterMethod = ($className, $methodName) => {
    otv_StepRecorder_$callClinit();
},
...
jlr_Modifier_getModifierNames = () => {
    ...
    if (jlr_Modifier_modifierNames === null)
        jlr_Modifier_modifierNames = $rt_wrapArray(jl_String, [$rt_s(14), $rt_s(15), $rt_s(16), $rt_s(17), $rt_s(18), $rt_s(19), $rt_s(20), $rt_s(21), $rt_s(22), $rt_s(23), $rt_s(24), $rt_s(25)]);
...
jl_AbstractStringBuilder_insert0 = ($this, $index, $obj) => {
    return $this.$insert0($index, $obj === null ? $rt_s(3) : $obj.$toString());
},
...
jlr_AccessibleObject_setAccessible = ($this, $flag) => {
    return;
};
let otrr_FieldInfo = $rt_classWithoutFields(otrr_ReflectionInfo);
function jlr_Field() {
...
jlr_Field_toString = $this => {
    ...
    if ($sb.$length() > 0)
        $sb.$append0(32);
    (((($sb.$append2(jl_Class_getName($this.$getType()))).$append0(32)).$append2(jl_Class_getName($this.$declaringClass))).$append2($rt_s(27))).$append2($this.$getName());
    return $sb.$toString();
},
...
function otvf_LinkedListFixture$Node() {
    let a = this; jl_Object.call(a);
    a.$val = 0;
    a.$next = null;
}
let otvf_LinkedListFixture$Node__init_0 = ($this, $val, $next) => {
    otv_StepRecorder_enterMethod($rt_s(28), $rt_s(29));
    otv_StepRecorder_step($rt_s(28), $rt_s(29), 34);
    otv_StepRecorder_captureVar($rt_s(30), $val);
    otv_StepRecorder_captureRef($rt_s(31), $next);
    jl_Object__init_($this);
    otv_StepRecorder_step($rt_s(28), $rt_s(29), 35);
    otv_StepRecorder_captureVar($rt_s(30), $val);
    otv_StepRecorder_captureRef($rt_s(31), $next);
    otv_StepRecorder_captureRef($rt_s(32), $this);
    $this.$val = $val;
    otv_StepRecorder_step($rt_s(28), $rt_s(29), 36);
    otv_StepRecorder_captureVar($rt_s(30), $val);
    otv_StepRecorder_captureRef($rt_s(31), $next);
    otv_StepRecorder_captureRef($rt_s(32), $this);
    $this.$next = $next;
...
otvf_LinkedListFixture$Node__init_ = (var_0, var_1) => {
    let var_2 = new otvf_LinkedListFixture$Node();
    otvf_LinkedListFixture$Node__init_0(var_2, var_0, var_1);
    return var_2;
};
function jl_Class() {
    let a = this; jl_Object.call(a);
...
jl_Class_toString = $this => {
    let var$1, var$2, var$3;
    var$1 = jl_Class_isInterface($this) ? $rt_s(33) : !jl_Class_isPrimitive($this) ? $rt_s(34) : $rt_s(0);
            ...
            if ($itemType !== null) {
                ...
                if ($itemName !== null) {
                    if ($itemType[$rt_meta].itemType !== null) {
                        ...
                        var$5 = jl_StringBuilder__init_();
                        jl_StringBuilder_append0(jl_StringBuilder_append(jl_StringBuilder_append(var$5, $rt_s(35)), $itemName), 59);
                        $result = jl_StringBuilder_toString(var$5);
                    }
                }
            }
    ...
    if (!($this.$flags & 2)) {
        ...
        if ($result === null) {
            if ($this.$classInfo[$rt_meta].itemType !== null) {
                ...
                var$4 = jl_StringBuilder__init_();
                jl_StringBuilder_append(jl_StringBuilder_append(var$4, var$3), $rt_s(36));
...
otvf_LinkedListFixture = $rt_classWithoutFields(),
otvf_LinkedListFixture_$callClinit = () => {
    otvf_LinkedListFixture_$callClinit = $rt_eraseClinit(otvf_LinkedListFixture);
    otvf_LinkedListFixture__clinit_();
},
otvf_LinkedListFixture_main = $args => {
    let $n1, $n2, $n3, $sum, $max, var$7, var$8;
    otvf_LinkedListFixture_$callClinit();
    otv_StepRecorder_enterMethod($rt_s(37), $rt_s(38));
    otv_StepRecorder_step($rt_s(37), $rt_s(38), 41);
    otv_StepRecorder_captureRef($rt_s(39), $args);
    $n1 = otvf_LinkedListFixture$Node__init_(99, null);
    otv_StepRecorder_step($rt_s(37), $rt_s(38), 42);
    otv_StepRecorder_captureRef($rt_s(39), $args);
    otv_StepRecorder_captureRef($rt_s(40), $n1);
    $n2 = otvf_LinkedListFixture$Node__init_(17, $n1);
    otv_StepRecorder_step($rt_s(37), $rt_s(38), 43);
    otv_StepRecorder_captureRef($rt_s(39), $args);
    otv_StepRecorder_captureRef($rt_s(40), $n1);
    otv_StepRecorder_captureRef($rt_s(41), $n2);
    $n3 = otvf_LinkedListFixture$Node__init_(42, $n2);
    otv_StepRecorder_step($rt_s(37), $rt_s(38), 45);
    otv_StepRecorder_captureRef($rt_s(39), $args);
    otv_StepRecorder_captureRef($rt_s(40), $n1);
    otv_StepRecorder_captureRef($rt_s(41), $n2);
    otv_StepRecorder_captureRef($rt_s(42), $n3);
    $sum = ($n1.$val + $n2.$val | 0) + $n3.$val | 0;
    otv_StepRecorder_step($rt_s(37), $rt_s(38), 46);
    otv_StepRecorder_captureRef($rt_s(39), $args);
    otv_StepRecorder_captureRef($rt_s(40), $n1);
    otv_StepRecorder_captureRef($rt_s(41), $n2);
    otv_StepRecorder_captureRef($rt_s(42), $n3);
    otv_StepRecorder_captureVar($rt_s(43), $sum);
    $max = $n1.$val;
    otv_StepRecorder_step($rt_s(37), $rt_s(38), 47);
    otv_StepRecorder_captureRef($rt_s(39), $args);
    otv_StepRecorder_captureRef($rt_s(40), $n1);
    otv_StepRecorder_captureRef($rt_s(41), $n2);
    otv_StepRecorder_captureRef($rt_s(42), $n3);
    otv_StepRecorder_captureVar($rt_s(43), $sum);
    otv_StepRecorder_captureVar($rt_s(44), $max);
    if ($n2.$val > $max) {
        otv_StepRecorder_step($rt_s(37), $rt_s(38), 48);
        otv_StepRecorder_captureRef($rt_s(39), $args);
        $max = $n2.$val;
    }
    otv_StepRecorder_step($rt_s(37), $rt_s(38), 50);
    otv_StepRecorder_captureRef($rt_s(39), $args);
    otv_StepRecorder_captureVar($rt_s(44), $max);
    if ($n3.$val > $max) {
        otv_StepRecorder_step($rt_s(37), $rt_s(38), 51);
        otv_StepRecorder_captureRef($rt_s(39), $args);
        otv_StepRecorder_captureVar($rt_s(44), $max);
        $max = $n3.$val;
    }
    otv_StepRecorder_step($rt_s(37), $rt_s(38), 54);
    otv_StepRecorder_captureRef($rt_s(39), $args);
    otv_StepRecorder_captureVar($rt_s(44), $max);
    var$7 = jl_System_out();
    var$8 = jl_StringBuilder__init_();
    jl_StringBuilder_append1(jl_StringBuilder_append(var$8, $rt_s(45)), $sum);
    var$7.$println(jl_StringBuilder_toString(var$8));
    otv_StepRecorder_step($rt_s(37), $rt_s(38), 55);
    otv_StepRecorder_captureRef($rt_s(39), $args);
    otv_StepRecorder_captureVar($rt_s(44), $max);
    otv_StepRecorder_captureVar($rt_s(43), $sum);
    var$7 = jl_System_out();
    var$8 = jl_StringBuilder__init_();
    jl_StringBuilder_append1(jl_StringBuilder_append(var$8, $rt_s(46)), $max);
    var$7.$println(jl_StringBuilder_toString(var$8));
    otv_StepRecorder_exitMethod();
},
otvf_LinkedListFixture__clinit_ = () => {
...
$rt_packages([-1, "java", 0, "lang", 1, "reflect", -1, "org", 3, "teavm", 4, "classlib", 5, "impl", 6, "console", 5, "java", 8, "lang", 4, "visualizer", 10, "fixture"
]);
...
jl_Integer, "Integer", 1, jl_Number, [jl_Comparable], 1, [0,0,0], jl_Integer_$callClinit, ["$_init_1", $rt_wrapFunction1(jl_Integer__init_), "$toString", $rt_wrapFunction0(jl_Integer_toString)],
...
$rt_metadata([otr_StringInfo, 0, otrr_ReflectionInfo, [], 17, 0, 0, 0,
...
otvf_LinkedListFixture$Node, "LinkedListFixture$Node", 11, jl_Object, [], 16, [otvf_LinkedListFixture,0,"Node"], 0, ["$_init_10", $rt_wrapFunction2(otvf_LinkedListFixture$Node__init_0)],
...
otvf_LinkedListFixture, 0, jl_Object, [], 17, 0, otvf_LinkedListFixture_$callClinit, 0]);
$rt_reflection([
    ...
    otvf_LinkedListFixture$Node, {
        f: [
            ["val", 0, $rt_intcls, o => o.$val, 0],
            ["next", 0, otvf_LinkedListFixture$Node, o => o.$next, 0]
        ]
    }, 
    jl_Object, {
...
$rt_stringPool(["", ": ", "0", "null", "@", ":", "{", ",", "=", "}", "\u0000VIZ:step", "\u0000VIZ:var:", "\u0000VIZ:truncated", "default", "public", "protected", "private", "abstract", "static", "final", "transient", "volatile", "synchronized", "native", "strictfp", "interface", "\n", ".", "org.teavm.visualizer.fixture.LinkedListFixture$Node", "<init>", "val", "next", "this", "interface ", "class ", "[L", "[]", "org.teavm.visualizer.fixture.LinkedListFixture", "main", "args", "n1", "n2", "n3", "sum", "max",
"Sum = ", "Max = "]);
...
let $rt_export_main = $rt_mainStarter(otvf_LinkedListFixture_main);
