...
otcic_JsConsolePrintStream_println0 = ($this, $i) => {
    $this.$println(jl_Integer_toString($i));
},
...
otvf_MultiMethodExample = $rt_classWithoutFields(),
otvf_MultiMethodExample_$callClinit = () => {
    otvf_MultiMethodExample_$callClinit = $rt_eraseClinit(otvf_MultiMethodExample);
    otvf_MultiMethodExample__clinit_();
},
otvf_MultiMethodExample_factorial = $n => {
    let $result, $i;
    otvf_MultiMethodExample_$callClinit();
    otv_StepRecorder_enterMethod($rt_s(27), $rt_s(28));
    otv_StepRecorder_step($rt_s(27), $rt_s(28), 27);
    otv_StepRecorder_captureVar($rt_s(29), $n);
    $result = 1;
    otv_StepRecorder_step($rt_s(27), $rt_s(28), 28);
    otv_StepRecorder_captureVar($rt_s(29), $n);
    otv_StepRecorder_captureVar($rt_s(30), $result);
    $i = 2;
    while (true) {
        otv_StepRecorder_step($rt_s(27), $rt_s(28), 29);
        otv_StepRecorder_captureVar($rt_s(29), $n);
        otv_StepRecorder_captureVar($rt_s(30), $result);
        otv_StepRecorder_captureVar($rt_s(31), $i);
        if ($i > $n)
            break;
        otv_StepRecorder_step($rt_s(27), $rt_s(28), 30);
        otv_StepRecorder_captureVar($rt_s(29), $n);
        otv_StepRecorder_captureVar($rt_s(30), $result);
        otv_StepRecorder_captureVar($rt_s(31), $i);
        $result = $rt_imul($result, $i);
        otv_StepRecorder_step($rt_s(27), $rt_s(28), 31);
        otv_StepRecorder_captureVar($rt_s(29), $n);
        otv_StepRecorder_captureVar($rt_s(30), $result);
        otv_StepRecorder_captureVar($rt_s(31), $i);
        $i = $i + 1 | 0;
    }
    otv_StepRecorder_step($rt_s(27), $rt_s(28), 33);
    otv_StepRecorder_captureVar($rt_s(29), $n);
    otv_StepRecorder_captureVar($rt_s(30), $result);
    otv_StepRecorder_captureVar($rt_s(31), $i);
    otv_StepRecorder_exitMethod();
...
otvf_MultiMethodExample_choose = ($n, $k) => {
    let $nFact, $kFact, $nkFact, var$6;
    otvf_MultiMethodExample_$callClinit();
    otv_StepRecorder_enterMethod($rt_s(27), $rt_s(32));
    otv_StepRecorder_step($rt_s(27), $rt_s(32), 37);
    otv_StepRecorder_captureVar($rt_s(29), $n);
    otv_StepRecorder_captureVar($rt_s(33), $k);
    $nFact = otvf_MultiMethodExample_factorial($n);
    otv_StepRecorder_step($rt_s(27), $rt_s(32), 38);
    otv_StepRecorder_captureVar($rt_s(29), $n);
    otv_StepRecorder_captureVar($rt_s(33), $k);
    otv_StepRecorder_captureVar($rt_s(34), $nFact);
    $kFact = otvf_MultiMethodExample_factorial($k);
    otv_StepRecorder_step($rt_s(27), $rt_s(32), 39);
    otv_StepRecorder_captureVar($rt_s(29), $n);
    otv_StepRecorder_captureVar($rt_s(33), $k);
    otv_StepRecorder_captureVar($rt_s(34), $nFact);
    otv_StepRecorder_captureVar($rt_s(35), $kFact);
    $nkFact = otvf_MultiMethodExample_factorial($n - $k | 0);
    otv_StepRecorder_step($rt_s(27), $rt_s(32), 40);
    otv_StepRecorder_captureVar($rt_s(29), $n);
    otv_StepRecorder_captureVar($rt_s(33), $k);
    otv_StepRecorder_captureVar($rt_s(34), $nFact);
    otv_StepRecorder_captureVar($rt_s(35), $kFact);
    otv_StepRecorder_captureVar($rt_s(36), $nkFact);
    var$6 = $nFact / $rt_imul($kFact, $nkFact) | 0;
    otv_StepRecorder_exitMethod();
    return var$6;
},
otvf_MultiMethodExample_main = $args => {
    otvf_MultiMethodExample_$callClinit();
    otv_StepRecorder_enterMethod($rt_s(27), $rt_s(37));
    otv_StepRecorder_step($rt_s(27), $rt_s(37), 44);
    otv_StepRecorder_captureRef($rt_s(38), $args);
    (jl_System_out()).$println0(otvf_MultiMethodExample_choose(5, 2));
    otv_StepRecorder_exitMethod();
},
otvf_MultiMethodExample__clinit_ = () => {
    return;
...
let otcic_JSStderrPrintStream__init_ = $this => {
    otcic_JsConsolePrintStream__init_($this);
},
...
jlr_Field_toString = $this => {
    ...
    if ($sb.$length() > 0)
        $sb.$append0(32);
    (((($sb.$append2(jl_Class_getName($this.$getType()))).$append0(32)).$append2(jl_Class_getName($this.$declaringClass))).$append2($rt_s(39))).$append2($this.$getName());
    return $sb.$toString();
},
...
jl_Class_toString = $this => {
    let var$1, var$2, var$3;
    var$1 = jl_Class_isInterface($this) ? $rt_s(40) : !jl_Class_isPrimitive($this) ? $rt_s(41) : $rt_s(0);
            ...
            if ($itemType !== null) {
                ...
                if ($itemName !== null) {
                    if ($itemType[$rt_meta].itemType !== null) {
                        ...
                        var$5 = jl_StringBuilder__init_();
                        jl_StringBuilder_append0(jl_StringBuilder_append(jl_StringBuilder_append(var$5, $rt_s(42)), $itemName), 59);
                        $result = jl_StringBuilder_toString(var$5);
                    }
                }
            }
    ...
    if (!($this.$flags & 2)) {
        ...
        if ($result === null) {
            if ($this.$classInfo[$rt_meta].itemType !== null) {
                ...
                var$4 = jl_StringBuilder__init_();
                jl_StringBuilder_append(jl_StringBuilder_append(var$4, var$3), $rt_s(43));
...
otcic_JsConsolePrintStream, 0, ji_PrintStream, [], 1025, 0, 0, ["$_init_", $rt_wrapFunction0(otcic_JsConsolePrintStream__init_), "$println", $rt_wrapFunction1(otcic_JsConsolePrintStream_println), "$println0", $rt_wrapFunction1(otcic_JsConsolePrintStream_println0)],
...
otvf_MultiMethodExample, 0, jl_Object, [], 17, 0, otvf_MultiMethodExample_$callClinit, 0,
...
let $rt_export_main = $rt_mainStarter(otvf_MultiMethodExample_main);
